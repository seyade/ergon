  ...
  return (
    <div className="px-4 xl:px-6">
      ...
      <div className="py-6 lg:pb-4 lg:pt-8">
        <Header
          title="Capsule Corp Spaceship"
          buttonComponent={
            <button
              className="flex items-center rounded-md bg-blue-primary px-3 py-2 text-white hover:bg-blue-600"
              onClick={() => setIsNewProjectModalOpen(true)}
            >
              <PlusSquare className="m2-2 h-5 w-5" />
              &nbsp;New Board
            </button>
          }
        />
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <input
              ...
              className="rounded-md border py-2 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white"
            />
